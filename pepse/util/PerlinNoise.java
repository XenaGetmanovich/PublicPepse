...
/**
 * Perlin Noise.
 * This class is based on the implementation here:
 * https://gist.github.com/alksily/7a85a1898e65c936f861ee93516e397d.
 */
public class PerlinNoise {
    private final double generalSeed;
    private double seed;
    private final long default_size = 2000;
    private int[] p;

    public PerlinNoise(double generalSeed) {
        this.generalSeed = generalSeed;
        init();
    }
    ...
    public double noise(double x) {
        this.seed = Objects.hash(generalSeed, x);
        double value = 0.0;
